...
public class EmployeesDao {
    ...
    public boolean registerEmployeeQuery(Employees employee) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "error al registrar al empleado" + e.getMessage());
            return false;
        }
    }
    ...
    public boolean updateEmployeeQuery(Employees employee) {
        ...
        try {
            ...
            System.err.println("el error : " + e.getMessage());
            JOptionPane.showMessageDialog(views, "error al actualizar al empleado" + e);
            return false;
        }
    }
    ...
    public boolean deleteEmployeeQuery(int id) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "error al eliminar al empleado que tiene "
    ...
    public boolean updateEmployeePassword(Employees employee) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "error al actualizar la contraseña del empleado que tiene " + e);
            return false;
        }
    }
}
